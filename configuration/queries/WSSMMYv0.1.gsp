...
<package-comment/>
<businessobject displayString="WSSMMYv0.1" type="com.j2fe.translation.template.QueryDefinition">
<com.j2fe.translation.template.QueryDefinition id="0">
<name id="1">WSSMMYv0.1</name>
...
FROM&#13;
  (SELECT&#13;
    ...
    CASE ISCL1.CL_VALUE&#13;
      ...
      WHEN 'SWAP'&#13;
      THEN&#13;
        --LOGIC - Check if swap is BBSW 3M/6M&#13;
