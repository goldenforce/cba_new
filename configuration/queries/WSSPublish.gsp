...
<package-comment/>
<businessobject displayString="WSSPublish" type="com.j2fe.translation.template.QueryDefinition">
<com.j2fe.translation.template.QueryDefinition id="0">
<name id="1">WSSPublish</name>
...
FROM&#13;
  ...
  FROM FT_T_GPCS&#13;
  JOIN FT_T_ISPC&#13;
  ON FT_T_GPCS.ISS_PRC_ID = FT_T_ISPC.ISS_PRC_ID&#13;
  JOIN FT_T_ISSU&#13;
  ON FT_T_ISPC.INSTR_ID = FT_T_ISSU.INSTR_ID&#13;
  JOIN FT_T_ISID&#13;
  ON FT_T_ISID.INSTR_ID = FT_T_GPCS.INSTR_ID&#13;
  JOIN FT_T_ISCL ISCL1&#13;
  ON FT_T_ISPC.INSTR_ID     = ISCL1.INSTR_ID&#13;
  AND ISCL1.indus_cl_set_id = 'CBAISS'&#13;
  JOIN FT_T_ISCL ISCL2&#13;
  ON FT_T_ISPC.INSTR_ID     = ISCL2.INSTR_ID&#13;
  ...
  AND FT_T_ISID.ISS_ID       IN&#13;
    ...
    WHERE ISID_OID IN&#13;
      (SELECT ISID_OID&#13;
      FROM FT_T_ISGP&#13;
      WHERE FT_T_ISGP.PRNT_ISS_GRP_OID = 'WSS=ISGR01'&#13;
      )&#13;
    )&#13;
  ...
  AND TO_DATE(FT_T_GPCS.PRC_TMS, 'DD/MM/YY') = '04/MAY/18'&#13;
  AND FT_T_GPCS.GPRC_IND                     = 'Y'&#13;
    --AND FT_T_GPCS.GPCS_TYP = 'VALID'&#13;
  AND FT_T_GPCS.PPED_OID = 'SNAP====SY'&#13;
    --AND FT_T_GPCS.GPRC_IND IS NOT NULL&#13;
    --AND FT_T_GPCS.PRC_CURR_CDE = 'HKD'&#13;
    --AND FT_T_GPCS.LAST_CHG_TMS = '01/MAR/18'&#13;
  ORDER BY 1 ASC&#13;
  ) </text>
