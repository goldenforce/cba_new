...
<package-comment/>
<businessobject displayString="4 - Trigger Point Shift Rule 30032018" type="com.j2fe.workflow.definition.Workflow">
<com.j2fe.workflow.definition.Workflow id="0">
<alwaysPersist>false</alwaysPersist>
<clustered>true</clustered>
<comment id="1">Trigger Point Shift Rule 30032018</comment>
<endNode id="2">
...
<stringValue id="60">TriggerDeleteFUT1Reuters</stringValue>
<type>CONSTANT</type>
</item>
...
<clusteredCall>false</clusteredCall>
<directJoin>false</directJoin>
<name id="71">Fetch Rics and Create Streerref</name>
...
String ricvaluesinselect = new String();&#13;
&#13;
//List ricsSplitted = new ArrayList();&#13;
&#13;
if(!(null == ricIds || ricIds.isEmpty()))&#13;
{&#13;
ricvaluesinselect = ricIds.trim();&#13;
&#13;
//ricsSplitted  = Arrays.asList(ricvaluesinselect.split(","));&#13;
}&#13;
&#13;
List ricsSplitted = Arrays.asList(ricvaluesinselect.split(","));&#13;
		String queryForStreetRef =  " SELECT  '&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt; "&#13;
				+" &lt;!DOCTYPE STREET_REF SYSTEM \"fti://repository/dtd/STREET_REF\"&gt;' || "&#13;
				        +" XMLElement(NAME \"STREET_REF\", "&#13;
				            ...
				            +" XMLElement(NAME \"HEADER\", "&#13;
				               +"  XMLElement(\"DATASOURCE\" ,XMLAttributes('REUTERS' AS \"VALUE\")), "&#13;
				                +" XMLElement(\"MAIN_ENTITY_TBL_TYP\",XMLAttributes( 'ISSU' AS \"VALUE\")), "&#13;
				               +" XMLElement(\"MSGCLASSIFICATION\",XMLAttributes('RRRPRC' AS \"VALUE\")), "&#13;
				               +" XMLElement(\"USERID\",XMLAttributes( 'CBA:WKF' AS \"VALUE\")), "&#13;
				               +" XMLElement(\"MAIN_ENTITY_ID_CTXT_TYP\",XMLAttributes( 'RIC' AS \"VALUE\")), "&#13;
				               +" XMLElement(\"MAIN_ENTITY_ID\",XMLAttributes( A.FUT_CHAIN AS \"VALUE\")) "&#13;
				                  +"     ), "&#13;
				               +" XMLElement(\"SEGMENT\", "&#13;
				...
				+" AND (B.END_TMS &gt; SYSDATE OR B.END_TMS IS NULL) AND B.ID_CTXT_TYP='RIC' "&#13;
				+" AND A.FUT_CHAIN = B.ISS_ID AND A.TICKER_ID  in ("+ricvaluesinselect+")";</objectValue>
<type>CONSTANT</type>
</item>
...
<input>true</input>
<name id="97">variables["ricIds"]</name>
<stringValue id="98">RicIds</stringValue>
<type>VARIABLE</type>
</item>
<item id="99" type="com.j2fe.workflow.definition.Parameter">
<input>false</input>
<name id="100">variables["ricvaluesinselect"]</name>
<stringValue id="101">ricvaluesinselect</stringValue>
<type>VARIABLE</type>
</item>
</parameters>
...
<group id="169">Cba/CBAChainRIC</group>
<haltOnError>false</haltOnError>
<lastChangeUser id="170">CBA_GC_OWN</lastChangeUser>
<lastUpdate id="171">2018-03-29T23:26:43.000+1100</lastUpdate>
<name id="172">CBACustom_WF_DeleteFUT1Reuters</name>
...
<entry>
<key id="177" type="java.lang.String">RicIds</key>
...
<entry>
<key id="197" type="java.lang.String">RicIds</key>
